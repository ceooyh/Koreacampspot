...
public class SpotDTO {
	...
	public SpotDTO(int sno, String id, String sname, String address1, String address2, String address3, String tel1,
			...
			int caravan_open, int trailer_open, int beach, int island, int mountain, int forest, int valley,
			int river, int lake, int city, int wifi, int hot_water, int shower, int mart, int toilet, int electric,
			int pet_open, int status) {
		super();
		this.sno = sno;
		this.id = id;
		this.sname = sname;
	...
	public String toString() {
		return "SpotDTO [sno=" + sno + ", id=" + id + ", sname=" + sname + ", address1=" + address1 + ", address2="
				...
				+ ", electric=" + electric + ", pet_open=" + pet_open + ", status=" + status + "]";
	}
}
